...
>
To-Do list is application that build used Javascript,HTML and css. This project show a list o activities that should be done by a person in a list manner , compleated list marked as complete and can remove easily by clicking a button.
...
```
git clone https://github.com/nilab-khwaja/To-Do-List
```
...
Feel free to check the [issues page](https://github.com/nilab-khwaja/To-Do-List/issues).
